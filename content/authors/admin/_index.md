...
- icon: envelope
  icon_pack: fas
  link: '#contact'  # For a direct email link, use "mailto:courtneygerver@gmail.com".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/CourtneyGerver
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=Swfzda4AAAAJ&hl=en
- icon: github
  icon_pack: fab
  link: https://github.com/CourtneyGerver
